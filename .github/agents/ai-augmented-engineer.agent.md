...
tools: ['runCommands', 'runTasks', 'edit', 'runNotebooks', 'search', 'new', 'serena/*', 'extensions', 'todos', 'runSubagent', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch']
---
